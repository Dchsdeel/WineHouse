...
if ($_SERVER["REQUEST_METHOD"] == "post") {
  if (empty($_POST["email"])) {
    ...
    if (!preg_match("/^[A-Z' ]*$/",$name)) {
      $nameErr = "Only Capital letter required";
    }
  }
}
...
if(isset($_POST['register'])){
   ...
   $pattern = "/^[a-zA-Z\d]+@[a-zA-Z\d]+\.[a-zA-Z\d\.]{2,}+$/";
...
<head>
   ...
   <link rel="shortcut icon" type="x-icon" href="images/wine-icon.png">
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Wine</span> House.</a>
      <nav class="navbar">
         <a href="#home">Home</a>
...
<div class="user-account">
   ...
   <section>
      ...
      <div id="close-account"><span>close x</span></div>
      ...
      <div class="flex">
         ...
         <form action="user_login.php" method="post">
            <h3>Login now</h3>
            <input type="email" name="email" required class="box" placeholder="enter your email" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
         ...
         <form action="" method="post">
            <h3>Register now</h3>
            <input type="text" name="name" oninput="this.value = this.value.replace(/\s/g, '')" required class="box" placeholder="enter your username" >
...
<div class="my-orders">
   ...
   <section>
      ...
      <div id="close-orders"><span>close x</span></div>
...
<div class="shopping-cart">
   ...
   <section>
      ...
      <div id="close-cart"><span>close x</span></div>
      ...
      <div class="cart-total">Subtotal : <span>₱   <?= $grand_total; ?>/-</span></div>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/Bodegas-Vinícola.png" alt="">
            </div>
            <div class="content">
               <h3>Bodegas Vinícola</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/rustenberg.png" alt="">
            </div>
            <div class="content">
               <h3>Rustenberg</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/kadette.png" alt="">
            </div>
            <div class="content">
               <h3>Kadette</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>fermented grapes</h3>
         <p>Wine is an alcoholic drink typically made from fermented grapes. Yeast consumes the sugar in the grapes and converts it to ethanol and carbon dioxide, releasing heat in the process. Different varieties of grapes and strains of yeasts are major factors in different styles of wine.</p>
      ...
      <div class="box">
         <img src="images/winefriends.png" alt="">
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="grand-total">  Total Order: <span>₱<?= $grand_total; ?>/-</span></div>
...
<section class="faq" id="faq">
   ...
   <div class="accordion-container">
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>can I order for a box of wine?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, quas. Quidem minima veniam accusantium maxime, doloremque iusto deleniti veritatis quos.
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>how much proof of the wine?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis, quas. Quidem minima veniam accusantium maxime, doloremque iusto deleniti veritatis quos.
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>jhondeldichoso@gmail.com</p>
         <p>jairusmatriano@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Wine House</span> | all rights reserved!
   </div>
